...
@Autonomous(name="Autonomous CraterSide", group="Pushbot")
@SuppressWarnings("WeakerAccess")
//@TeleOp(name = "Time Slice Op Mode", group = "HardwarePushbot")
//@Disabled
public class KPAutonomousCrater extends LinearOpMode {
    //
    //Encoder enc;
